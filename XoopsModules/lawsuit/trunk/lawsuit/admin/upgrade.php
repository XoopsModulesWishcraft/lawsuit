...
if( $version >= 1.2 || $count > 0 ){
	...
	$sql[] = 
	"CREATE TABLE `".$xoopsDB->prefix('lawsuit_forms')."` (
	...
	$sql[] = 
	"INSERT INTO `".$xoopsDB->prefix('lawsuit_forms')."` VALUES (1, '".$method."', ".intval($sendto).", 1, '".$delimiter."', 'Contact Us', '"._SUBMIT."', 'Tell us about your comments for this site.', 'Contact us by filling out this form.', '');";
	...
	xoops_cp_header();
	xoops_confirm(array('goupgrade' => 1), LAWSUIT_URL.'admin/upgrade.php', 'Make sure you have your files and database backuped. Are you really ready to upgrade the module now?', 'Cut the crap and do it');
}
