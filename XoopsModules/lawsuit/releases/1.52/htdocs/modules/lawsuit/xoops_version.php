...
$modversion['releasedate'] = "Thursday: 12, November 2010";
...
$modversion['release_info'] = "Stable 2011/11/12";
$modversion['release_file'] = XOOPS_URL."/modules/lawsuit/docs/changelog.txt";
$modversion['release_date'] = "2011/11/12";
...
$modversion['tables'][6] = "lawsuit_validation";
...
$xoLawModule = $modulehandler->getByDirname('lawsuit');
if (is_object($xoLawModule)&&!empty($xoLawModule)) {
...
$modversion["config"][] = array(
    "name"          => "htaccess",
    "title"         => "_MI_LAWSUIT_HTACCESS",
    "description"   => "_MI_LAWSUIT_HTACCESS_DESC",
    "formtype"      => "yesno",
    "valuetype"     => "int",
    "default"       => false
    );
...
$modversion["config"][] = array(
    "name"          => "baseurl",
    "title"         => "_MI_LAWSUIT_BASEURL",
    "description"   => "_MI_LAWSUIT_BASEURL_DESC",
    "formtype"      => "text",
    "valuetype"     => "text",
    "default"       => 'contact-us'
    );
...
$modversion["config"][] = array(
    "name"          => "endofurl",
    "title"         => "_MI_LAWSUIT_ENDOFURL",
    "description"   => "_MI_LAWSUIT_ENDOFURL_DESC",
    "formtype"      => "text",
    "valuetype"     => "text",
    "default"       => '.html'
    );
