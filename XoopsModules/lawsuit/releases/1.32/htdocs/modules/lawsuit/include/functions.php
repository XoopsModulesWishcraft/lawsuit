  ...
  function adminMenu ($currentoption = 0)  {
	...
	#buttonbar ul { margin:0; margin-top: 15px; padding:10px 10px 0; list-style:none; }
	  ...
	  #buttonbar a:hover span { background-position:100% -150px; }
	   ...
	   // global $xoopsDB, $xoopsModule, $GLOBALS['xoopsConfig'], $xoopsModuleConfig;
	
	   $myts = &MyTextSanitizer::getInstance();
	
	   $tblColors = Array();
		// $adminmenu=array();
	   if (file_exists(XOOPS_ROOT_PATH . '/modules/' . 'lawsuit' . '/language/' . $GLOBALS['xoopsConfig']['language'] . '/modinfo.php')) {
		   include_once XOOPS_ROOT_PATH . '/modules/' . 'lawsuit' . '/language/' . $GLOBALS['xoopsConfig']['language'] . '/modinfo.php';
	   } else {
		   include_once XOOPS_ROOT_PATH . '/modules/' . 'lawsuit' . '/language/' . 'english/modinfo.php';
	   }
